...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    public int insert(BankAccountDTO bankAccountDTO) {
        ...
        //根据银行卡号查询所属银行名称
        String cardName = this.queryBankNameByCardNumber(bankAccountDTO.getCode());
        if(StringUtil.isEmpty(cardName)){
            return 3;//3代表银行卡号不正确
        }
        bankAccountDTO.setBankName(cardName);
    ...
    //通过银行卡号查找所在银行名称
    @Override
    public String queryBankNameByCardNumber(String cardNumber) {
        ...
        System.out.println(bankName[index].substring(0,4));
