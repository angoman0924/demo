...
public class BaseException extends Exception {
     ...
     *
     */
    public BaseException(Code code, String userMessage){
        super(userMessage);
        if(code==null){
            throw new NullPointerException("code 不能为空");
        }
        if(userMessage==null){
            throw new NullPointerException("userMessage 不能为空");
        }
     ...
     *
     */
    public BaseException addArgument(String key, Object value){
