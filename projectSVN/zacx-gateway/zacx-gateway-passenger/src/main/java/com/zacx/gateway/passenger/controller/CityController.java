...
import com.zacx.gateway.passenger.dto.basic.CityResult;
...
public class CityController {
    ...
    public Result<List<CityResult>> cities(String cityName){
    ...
    public Result<List<CityResult>> hotCities(){
        ...
        for (CityDTO c: list){
            ...
            for (CityDTO c2: c.getRelationCity()){
                CityResult cityResult2 = new CityResult();
                cityResult2.setId(c2.getId());
                cityResult2.setName(c2.getName());
                cityResult2.setParentCode(c2.getCode());
                cities.add(cityResult2);
            }
        }
